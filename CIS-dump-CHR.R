...
require(ggplot2)
p <- ggplot(d, aes(TypeStatus)) + labs(title = "Types in the CHR") + labs(x = "'Kind' of type", y = "number of isolates")
...
attach(d) #this means we don't need the $ sign
require(ggplot2)
p <- ggplot(d, aes(TypeStatus, fill=SpecimenType)) + labs(title = "Types in the CHR") + labs(x = "'Kind' of type", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(SpecimenType)) + labs(title = "Specimens in the CHR by Specimen type") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump)
require(ggplot2)
p <- ggplot(CHR.dump, aes(SpecimenType, fill=GenBank)) + labs(title = "Specimens in the CHR in GenBank") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(SpecimenType, fill=Literature)) + labs(title = "Specimens in the CHR in Literature") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(SpecimenType, fill=Images)) + labs(title = "Specimens in the CHR with images") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(SpecimenType, fill=OccurrenceDescription)) + labs(title = "Specimens in the CHR by occurrence in NZ") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(CollectionEventMethod)) + labs(title = "Specimens in the CHR by Collection Event Method") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(OccurrenceDescription)) + labs(title = "Specimens in the CHR by occurrence in NZ") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(SpecimenType, fill= LoanStatus)) + labs(title = "CHR Order Status") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(SpecimenType, fill= UpdatedBy)) + labs(title = "CHR Last updated by") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(Phylum)) + labs(title = "CHR by phylum") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(Class)) + labs(title = "CHR by class") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(Order)) + labs(title = "CHR by order") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(Order, fill=SpecimenType)) + labs(title = "CHR by order") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(Family)) + labs(title = "CHR by bacterial family") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(f) 
require(ggplot2)
p <- ggplot(f, aes(Phylum)) + labs(title = "CHR by fungal phylum") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(f) 
require(ggplot2)
p <- ggplot(f, aes(Class)) + labs(title = "CHR by fungal class") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(f) 
require(ggplot2)
p <- ggplot(f, aes(Order)) + labs(title = "CHR by fungal order") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(f) 
require(ggplot2)
p <- ggplot(f, aes(Family)) + labs(title = "CHR by fungal family") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
attach(CHR.dump.NZ) 
require(ggplot2)
p <- ggplot(CHR.dump, aes(NZAreaCode)) + labs(title = "NZ Specimens in the CHR by Area Code") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
...
require(ggplot2)
con <- ggplot(c, aes(Country, fill=SpecimenType)) + labs(title = "Top 10 Countries in the CHR") + labs(x = "Country", y = "number of isolates")
con <- con + theme(axis.text.x=element_text(angle=-90, hjust=0))
...
attach(c) #this means we don't need the $ sign
require(ggplot2)
con <- ggplot(c, aes(Country, fill=SpecimenType)) + labs(title = "Pacific Countries Specimens in the CHR") + labs(x = "Country", y = "number of isolates")
con <- con + theme(axis.text.x=element_text(angle=-90, hjust=0))
con + geom_bar()+ coord_flip()
print_bars <- con + geom_bar()+ coord_flip()
...
attach(c) #this means we don't need the $ sign
require(ggplot2)
con <- ggplot(c, aes(Country, fill=SpecimenType)) + labs(title = "Top 10 Countries in the CHR (not including NZ)") + labs(x = "Country", y = "number of isolates")
con <- con + theme(axis.text.x=element_text(angle=-90, hjust=0))
con + geom_bar()+ coord_flip() + scale_x_discrete(limits = positions)
print_bars <- con + geom_bar()+ coord_flip() + scale_x_discrete(limits = positions)
...
attach(b) 
require(ggplot2)
p <- ggplot(CHR.dump.kiwifruit, aes(Family)) + labs(title = "Family of microbes on kiwifruit in the CHR") + labs(x = "Taxon", y = "number of isolates")
p <- p + theme(axis.text.x=element_text(angle=-90, hjust=0))
p + geom_bar()+ coord_flip()
print_bars <- p + geom_bar()+ coord_flip()
