...
#import the files
ICMP.initial.df <- read_csv("ICMP-export-2-dec-2021.csv")
...
sort(table(ICMP.df$StandardDeterminer),decreasing=TRUE)[1:11] #top 11 StandardDeterminer

sort(table(ICMP.df$DepositorName),decreasing=TRUE)[1:11] #top 11 DepositorName
