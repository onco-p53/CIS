...
#  tally()
#kbl(table.stypes, caption = "table of specimen types") %>% 
#kable_paper("hover", full_width = F) #can use striped instead of hover
...
```{r calulate earliest culture dates, echo=TRUE}
...
```{r NZ isolated month chart, echo=TRUE, warning=FALSE}
