...
```{r calulate earliest culture dates, echo=FALSE}
...
```{r all isolated dates chart, echo=FALSE, warning=TRUE}
...
```{r all deposited dates chart, echo=FALSE, warning=TRUE}
...
```{r bacteria deposits chart, echo=FALSE, warning=TRUE}
