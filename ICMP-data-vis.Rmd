...
```{r calulate earliest culture dates, include=FALSE}

#this is just for data checking e.g. ranking the eary ones don't display in the final version
...
```{r all deposited dates chart, echo=FALSE, warning=FALSE}
...
```{r bacteria deposits chart, echo=FALSE, warning=FALSE}
