...
The ICMP has `r count(ICMP.dump)` cultures
...
ktable.specimen3 <- ICMP.dump %>% 
  group_by(SpecimenType) %>%
  tally()
kable(ktable.specimen3, caption = "Basic stats") #knitr
...
May is the peak mushroom fruiting season, Jan may be an attifacet of missing mont or more likely the old way of entering data. Can I remove these??
